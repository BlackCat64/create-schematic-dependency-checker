...
public class CreateSchematicDependencyChecker {
    public static void main(String[] args) {
        ...
        try {
            ...
            Set<String> modIDs = getSchematicDependencies(schematicFile); // use helper method to retrieve dependencies of schematic
    ...
    public static Set<String> getSchematicDependencies(File schematicFile) throws Exception {
